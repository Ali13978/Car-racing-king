...
public class runtimeScript : MonoBehaviour
{
	...
	private void Start()
	{
		UnityEngine.Debug.Log("Please read the comments at the top before using the runtime API!");
		roadNetwork = new ERRoadNetwork();
		ERRoadType eRRoadType = new ERRoadType();
		eRRoadType.roadWidth = 6f;
		eRRoadType.roadMaterial = (Resources.Load("Materials/roads/single lane") as Material);
		eRRoadType.layer = 1;
