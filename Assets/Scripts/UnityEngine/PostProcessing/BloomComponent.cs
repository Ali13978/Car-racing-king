	...
	public sealed class BloomComponent : PostProcessingComponentRenderTexture<BloomModel>
	{
		...
		public override bool active
		{
			get
			{
				...
				{
					BloomModel.Settings settings = base.model.settings;
					if (settings.bloom.intensity > 0f)
					{
		...
		{
			BloomModel.Settings settings = base.model.settings;
			BloomModel.BloomSettings bloom = settings.bloom;
			BloomModel.Settings settings2 = base.model.settings;
			BloomModel.LensDirtSettings lensDirt = settings2.lensDirt;
