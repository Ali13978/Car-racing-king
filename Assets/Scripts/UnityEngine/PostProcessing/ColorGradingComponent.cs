namespace UnityEngine.PostProcessing
{
	public sealed class ColorGradingComponent : PostProcessingComponentRenderTexture<ColorGradingModel>
	{
		...
		private Texture2D GetCurveTexture()
		{
			...
			{
				m_GradingCurves = new Texture2D(128, 2, TextureFormat.RGBAHalf, mipChain: false, linear: true)
				{
			...
			ColorGradingModel.CurvesSettings curves = settings.curves;
		...
		public override void Prepare(Material uberMaterial)
		{
			...
			ColorGradingModel.Settings settings = base.model.settings;
			float value = Mathf.Exp(settings.basic.postExposure * 0.6931472f);
