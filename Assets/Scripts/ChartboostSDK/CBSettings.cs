...
namespace ChartboostSDK
{
	public class CBSettings : ScriptableObject
	{
		...
		[SerializeField]
		public string[] androidPlatformLabels = new string[2]
		{
			"Google Play",
			"Amazon"
		};
		...
		public int SelectedAndroidPlatformIndex => selectedAndroidPlatformIndex;
		...
		public static string getIOSAppId()
		{
			...
			{
				CredentialsWarning("CHARTBOOST: You are using the Chartboost {0} example {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "IOS", "App ID");
				return "4f21c409cd1cb2fb7000001b";
			}
			if (Instance.iOSAppId.Equals(string.Empty))
			{
				CredentialsWarning("CHARTBOOST: You are using an empty string for the {0} {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "IOS", "App ID");
			}
		...
		public static string getIOSAppSecret()
		{
			...
			{
				CredentialsWarning("CHARTBOOST: You are using the Chartboost {0} example {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "IOS", "App Signature");
				return "92e2de2fd7070327bdeb54c15a5295309c6fcd2d";
			}
			if (Instance.iOSAppSecret.Equals(string.Empty))
			{
				CredentialsWarning("CHARTBOOST: You are using an empty string for the {0} {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "IOS", "App Signature");
			}
		...
		public static string getAndroidAppId()
		{
			...
			{
				CredentialsWarning("CHARTBOOST: You are using the Chartboost {0} example {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Android", "App ID");
				return "4f7b433509b6025804000002";
			}
			if (Instance.androidAppId.Equals(string.Empty))
			{
				CredentialsWarning("CHARTBOOST: You are using an empty string for the {0} {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Android", "App ID");
			}
		...
		public static string getAndroidAppSecret()
		{
			...
			{
				CredentialsWarning("CHARTBOOST: You are using the Chartboost {0} example {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Android", "App Signature");
				return "dd2d41b69ac01b80f443f5b6cf06096d457f82bd";
			}
			if (Instance.androidAppSecret.Equals(string.Empty))
			{
				CredentialsWarning("CHARTBOOST: You are using an empty string for the {0} {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Android", "App Signature");
			}
		...
		public static string getAmazonAppId()
		{
			...
			{
				CredentialsWarning("CHARTBOOST: You are using the Chartboost {0} example {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Amazon", "App ID");
				return "542ca35d1873da32dbc90488";
			}
			if (Instance.amazonAppId.Equals(string.Empty))
			{
				CredentialsWarning("CHARTBOOST: You are using an empty string for the {0} {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Amazon", "App ID");
			}
		...
		public static string getAmazonAppSecret()
		{
			...
			{
				CredentialsWarning("CHARTBOOST: You are using the Chartboost {0} example {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Amazon", "App Signature");
				return "90654a340386c9fb8de33315e4210d7c09989c43";
			}
			if (Instance.amazonAppSecret.Equals(string.Empty))
			{
				CredentialsWarning("CHARTBOOST: You are using an empty string for the {0} {1}! Go to the Chartboost dashboard and replace these with an App ID & App Signature from your account! If you need help, email us: support@chartboost.com", "Amazon", "App Signature");
			}
